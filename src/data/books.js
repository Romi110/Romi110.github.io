 ...
 * rating:      0–5, any decimal e.g. 4.5 (null if not read)
...
export const BOOKS = [
  ...
  // ── Sun Eater ──────────────────────────────────────────────
  {
    ...
    status: 'read',
    rating: 3.99,
    review: "A slog of careful world building and a whiny punk protagonist. The world is as vast as \
    anything attempted in science fiction. The story is slow, but the universe and prose keep you engaged",
  ...
  },
  {
    ...
    status: 'read',
    rating: 4.5,
    review: "This book is all gas no breaks, It has everything, politics, war, space battles, romance and a crazy ending. Many \
    believe this is the peak of the Suneater series and it makes a good argument",
    genre: 'Science Fantasy',
    series: 'Sun Eater',
    seriesOrder: 3,
    pages: 608,
  ...
  },
  {
    ...
    status: 'read',
    rating: 4.3,
    review: "This book is torture porn. I don't know what else to say really. Nice prose while you suffer I guess",
    genre: 'Science Fantasy',
    series: 'Sun Eater',
    seriesOrder: 4,
    pages: 592,
  ...
  },
  {
    ...
    status: 'read',
    rating: 4.2,
    review: "Book 4 and 5 of Suneater should have really been 1 long book. The endgame is developed. The story trudges \
    on after it destroys everything. Perfectly vague",
    genre: 'Science Fantasy',
    series: 'Sun Eater',
    seriesOrder: 5,
    pages: 560,
  ...
  },
  {
    ...
    status: 'read',
    rating: 4.63,
    review: "Before reading this book I knew very little of what was going to happen. \
    This book I don't even know how it accomplished everything it did.\
    Similar intrigue to Howling Dark, but magnified. For better or for worse? Maybe Both",
    genre: 'Science Fantasy',
    series: 'Sun Eater',
    seriesOrder: 6,
    pages: 704,
  ...
  },
  {
    ...
    status: 'read',
    rating: 4.35,
    review: "Hadrian Marlowe. This book was not the best sun eater book. Did it have its ups and downs? Yes.\
    It is hard to judge a conclusion with the answers and without. I hope the story of the Suneater is not over, \
    but we knew the ending from the beginning. The journey of Hadrian Marlowe is worth the read.",
    genre: 'Science Fantasy',
    series: 'Sun Eater',
    seriesOrder: 7,
    pages: 928,
  ...
  // ── Sword of Kaigen ────────────────────────────────────────
  {
    ...
    status: 'read',
    rating: 4.5,
    review: "This is a story about a mother's love if nothing else. A warriors repressed fury.\
     A prodigies suppressed emotion. A sons unrelenting devotion. This shit might get to you",
    genre: 'Fantasy',
    series: null,
    seriesOrder: null,
    pages: 384,
  ...
  // ── Red Rising trilogy ─────────────────────────────────────
  {
    ...
    status: 'read',
    rating: 3.8,
    review: "As much as highly rated red rising is, it seemingly always manages me to piss me off. The use of reverse dramatic irony\
     and also just the habit of just ending the story. John Wick Series. Sorry its not bad but im a hater",
  ...
  },
  {
    ...
    status: 'read',
    rating: 3.9,
    review: "Idk I feel like anything I'll say I'll just be hating",
    genre: 'Science Fiction',
    series: 'Red Rising',
    seriesOrder: 2,
    pages: 442,
  ...
  },
  {
    ...
    status: 'read',
    rating: 4.0,
    review: "It's not bad I swear I'm just a snob",
    genre: 'Science Fiction',
    series: 'Red Rising',
    seriesOrder: 3,
    pages: 514,
  ...
  // ── Mistborn Era 1 ─────────────────────────────────────────
  {
    ...
    status: 'read',
    rating: 4.4,
    review: "The mystery, the intrigue, the hard magic system. Mistborn 1 reignited my reading desires. A great book for\
    anyone to start reading beginning with Fantasy.",
    genre: 'Fantasy',
    series: 'Mistborn',
    seriesOrder: 1,
    pages: 541,
  ...
  },
  {
    ...
    status: 'read',
    rating: 4.3,
    review: "I don't know how Sanderson does it but the 'Sanderlanche' is a thing.\
    The second book is slower but the way Sanderson intermingles plots is impressive.",
    genre: 'Fantasy',
    series: 'Mistborn',
    seriesOrder: 2,
    pages: 590,
  ...
  },
  {
    ...
    status: 'read',
    rating: 4.6,
    review: "Bro holy shit that ending is insanity. He wrote this shit in 2006 and its 2026 and NOW their making media for it?\
    That is criminal truly. This book is when you truly realize what Sanderson is capable of. This is the series that got \
    Robert Jordans wife to pick him to finish Wheel of Time. Read this trilogy",
    genre: 'Fantasy',
    series: 'Mistborn',
    seriesOrder: 3,
    pages: 572,
  ...
  // ── Hobbit / Elantris (Fantasy standalones) ────────────────
  {
    ...
    status: 'read',
    rating: 4,
    review: "A classic, the hero's journey. not much to say a story very well known",
    genre: 'Fantasy',
    series: null,
    seriesOrder: null,
    pages: 310,
  ...
  },
  {
    ...
    status: 'read',
    rating: 3.7,
    review: "A decent start to Sanderson's career, but it feels a bit rushed\
     and lacks the depth of his later works. Tbh I audio booked  this one",
    genre: 'Fantasy',
    series: null,
    seriesOrder: null,
    pages: 492,
  ...
  // ── Dune ───────────────────────────────────────────────────
  {
    ...
    status: 'read',
    rating: 4.5,
    review: "FUCKING DUNE. The godfather of space operas.\
    Insane world-building. The story can be a bit confusing at times but\
    that is with any great science fantasy. Dune is worth it even without Timothée Chalamet",
    genre: 'Science Fantasy',
    series: 'Dune',
    seriesOrder: 1,
    pages: 604,
  ...
  },
  {
    ...
    status: 'read',
    rating: 4.35,
    review: "A terrible slog of boring. But at the same time a beautiful conclusion to certain Plots.\
    This one makes you think and feel broadly. A man you can see everything yet control nothing.",
    genre: 'Science Fantasy',
    series: 'Dune',
    seriesOrder: 2,
    pages: 226,
  ...
  // ── Sci-Fi standalones ─────────────────────────────────────
  {
    ...
    status: 'read',
    rating: 4.64,
    review: "This book is a love letter for those who will never explore space. Truly a worthy read for any science fiction fan.",
    genre: 'Science Fiction',
    series: null,
    seriesOrder: null,
    pages: 476,
